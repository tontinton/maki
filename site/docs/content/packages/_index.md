...
The agent can read a checkout, which is how you review one. Writes to it and
any read of the approvals file are refused. See
[Maki's own files](/docs/permissions/#maki-s-own-files).
