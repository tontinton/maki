...
use maki_agent::tools::{
    ...
    GREP_TOOL_NAME, LSP_DIAGNOSTICS_TOOL_NAME, LSP_DOCUMENT_SYMBOL_TOOL_NAME,
    LSP_GOTO_DEFINITION_TOOL_NAME, LSP_HOVER_TOOL_NAME, LSP_IMPLEMENTATION_TOOL_NAME,
    LSP_INCOMING_CALLS_TOOL_NAME, LSP_OUTGOING_CALLS_TOOL_NAME, LSP_REFERENCES_TOOL_NAME,
    LSP_WORKSPACE_SYMBOL_TOOL_NAME, MEMORY_TOOL_NAME, MULTIEDIT_TOOL_NAME, QUESTION_TOOL_NAME,
    READ_TOOL_NAME, SKILL_TOOL_NAME, TASK_TOOL_NAME, TODOWRITE_TOOL_NAME, WRITE_TOOL_NAME,
};
...
const DEFAULT_HINTS: &[(&str, ToolRenderHints)] = &[
    ...
    hint!(LSP_GOTO_DEFINITION_TOOL_NAME),
    hint!(LSP_REFERENCES_TOOL_NAME),
    hint!(LSP_HOVER_TOOL_NAME),
    hint!(LSP_DIAGNOSTICS_TOOL_NAME),
    hint!(LSP_IMPLEMENTATION_TOOL_NAME),
    hint!(LSP_DOCUMENT_SYMBOL_TOOL_NAME),
    hint!(LSP_WORKSPACE_SYMBOL_TOOL_NAME),
    hint!(LSP_INCOMING_CALLS_TOOL_NAME),
    hint!(LSP_OUTGOING_CALLS_TOOL_NAME),
];
